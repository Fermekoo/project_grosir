...
$sql_tb="SELECT * from stok_toko where id_toko='$idtoko'";
$exe_tb=mysqli_query($koneksi,$sql_tb);
$data_tb=mysqli_fetch_array($exe_tb);
$ttb=$data_tb['jumlah_toko'];
$ttb_t=$ttb + $jumlah;




$sql_g="update stok_toko, barang set stok_toko.jumlah_toko='$ttb_t', barang.jumlah='$t' where stok_toko.id_gudang='$idgudang' and barang.id_gudang='$idgudang'";
...
?>
			<?php
			$id_toko=$_GET['id'];
			$sql="SELECT * FROM stok_toko, barang where stok_toko.id_toko='$id_toko' and barang.id_gudang=stok_toko.id_gudang";
         ...
         <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input type="hidden" name="idtoko" class="form-control" id="exampleInputEmail1" value="<?php echo $data['id_toko'];?>" >
                </div>
                <div class="form-group">
